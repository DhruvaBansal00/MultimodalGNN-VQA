...
parser.add_argument('--input_questions_json', default='../../../data/CLEVR_v1.0/questions/CLEVR_train_questions.json')
...
parser.add_argument('--max_sample', default=10,
                    type=int, help='max ques. samples to collect from clevr_train. all 669K if 0')
parser.add_argument('--checkpoint_every', default=100,
